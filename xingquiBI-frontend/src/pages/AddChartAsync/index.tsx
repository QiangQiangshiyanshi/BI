import {genChartByBiAsyncUsingPOST, genChartByBiUsingPOST} from '@/services/yupiBI/chartController';
...
const AddchartAsync: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      const res = await genChartByBiAsyncUsingPOST(params, {}, values.file.file.originFileObj);
      if (!res?.data) {
        message.error('分析失败');
      } else {
