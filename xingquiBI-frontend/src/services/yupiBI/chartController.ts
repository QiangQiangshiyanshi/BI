...
/** genChartByBi POST /api/chart/gen */
export async function genChartByBiUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByBiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** genChartByBiAsync POST /api/chart/gen/async */
export async function genChartByBiAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByBiAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** genChartByBiAsyncMq POST /api/chart/gen/async/mq */
export async function genChartByBiAsyncMqUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByBiAsyncMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
